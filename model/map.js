var map = {
	...
	s01: { id: 's01', type: 'nothing', next: ['s00'] },
	s02: { id: 's02', type: 'nothing', next: ['s01'] },
	s03: { id: 's03', type: 'nothing', next: ['s02'] },
	...
	s21: { id: 's21', type: 'nothing', next: ['s00'] },
	s22: { id: 's22', type: 'nothing', next: ['s21'] },
	s23: { id: 's23', type: 'nothing', next: ['s22'] },
	...
	s31: { id: 's31', type: 'nothing', next: ['s32'] },
	s32: { id: 's32', type: 'nothing', next: ['s33'] },
	s33: { id: 's33', type: 'nothing', next: ['t3'] },
